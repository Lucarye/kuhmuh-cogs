...
class BlauesSchlachtfeldView(discord.ui.View):
    ...
    async def anmeldung_button(self, button: discord.ui.Button, interaction: discord.Interaction) -> None:
    ...
    async def platoon_button(self, button: discord.ui.Button, interaction: discord.Interaction) -> None:
        async def update(interaction: discord.Interaction) -> bool:
            if not await self._button_permission_check(interaction, "status_allowed_roles", "status_allowed_members"):
                return False
            guild_config = self.cog.config.guild(interaction.guild)
    ...
    async def captain_button(self, button: discord.ui.Button, interaction: discord.Interaction) -> None:
    ...
    async def sailor_button(self, button: discord.ui.Button, interaction: discord.Interaction) -> None:
    ...
    async def own_ship_button(self, button: discord.ui.Button, interaction: discord.Interaction) -> None:
    ...
    async def remove_button(self, button: discord.ui.Button, interaction: discord.Interaction) -> None:
    ...
    def _create_embed(self, guild: discord.Guild, data: Dict[str, Any]) -> discord.Embed:
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                f"**Startzeit (Berlin):** {data.get('start_time', '12:00')}\n"
